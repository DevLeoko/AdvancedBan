...
public class Punishment {
    ...
    public void create(){
        ...
        if(Universal.get().isUseMySQL()){
            if(getType() != PunishmentType.KICK) Universal.get().getMysql().executeSatement("INSERT INTO `Punishments` (`name`, `uuid`, `reason`, `operator`, `punishmentType`, `start`, `end`, `calculation`) VALUES ('"+getName()+"', '"+getUuid()+"', '"+getReason()+"', '"+getOperator()+"', '"+getType().name()+"', '"+getStart()+"', '"+getEnd()+"', '"+getCalculation()+"')");
            Universal.get().getMysql().executeSatement("INSERT INTO `PunishmentHistory` (`name`, `uuid`, `reason`, `operator`, `punishmentType`, `start`, `end`, `calculation`) VALUES ('"+getName()+"', '"+getUuid()+"', '"+getReason()+"', '"+getOperator()+"', '"+getType().name()+"', '"+getStart()+"', '"+getEnd()+"', '"+getCalculation()+"')");
            ResultSet rs = Universal.get().getMysql().executeRespSatemen("SELECT * FROM `Punishments` WHERE `uuid` = '"+getUuid()+"' AND `start` = '"+getStart()+"'");
    ...
    public void delete(){
        ...
        if(Universal.get().isUseMySQL()){
            Universal.get().getMysql().executeSatement("DELETE FROM `Punishments` WHERE `id` = "+getId());
        }else{
