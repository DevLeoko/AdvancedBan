...
import me.leoko.advancedban.core.manager.DatabaseManager;
import me.leoko.advancedban.core.manager.MessageManager;
import me.leoko.advancedban.core.manager.PunishmentManager;
import me.leoko.advancedban.core.manager.UUIDManager;
import me.leoko.advancedban.core.utils.commands.*;
import me.leoko.advancedban.core.utils.tabcompletion.*;
...
import static me.leoko.advancedban.core.utils.tabcompletion.MutableTabCompleter.list;
    ...
    WARNS(null,
            ...
            input -> {
                if (input.hasNext() && !input.getPrimary().matches("[1-9][0-9]*")) {
                    ...
                    String identifier = processName(new CommandInput(input.getSender(), new String[]{name}));
                    new ListProcessor(
